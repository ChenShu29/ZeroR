...
from opencood.models.sub_modules.test_modules import FAXModule
from opencood.models.sub_modules.test_modules import ResnetEncoder
from opencood.models.sub_modules.test_modules import NaiveDecoder
...
from opencood.models.fuse_modules.fuse_utils import batch_split
...
class CorpBEVT(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        x = rearrange(x, '(b l) v h w c -> b l v h w c', b=len(record_len))
        batch_dict.update({'inputs': x})
        ...
        # TODO: test mask
        com_mask = torch.ones_like(com_mask)
