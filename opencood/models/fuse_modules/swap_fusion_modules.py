...
class Attention(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        start_index = agent_size * self.window_size[1] * self.window_size[2]

        # add positional bias
        bias = self.relative_position_bias_table(self.relative_position_index[:start_index, -start_index:])
