...
def weight_reduce_loss(loss, weight, reduction, avg_factor):
...
def dice_loss(pred, target, weight=None, eps=1e-3, reduction='mean', naive_dice=False, avg_factor=None, ignore_index=None, frame_mask=None):
    ...
    Args:
        ...
        target (torch.Tensor): The learning label of the prediction,shape (n, *), same shape of pred.
        ...
        naive_dice (bool, optional): If false, use the dice loss defined in the V-Net paper,
            otherwise, use the naive dice loss in which the power of the number in the denominator is the first power instead of the second power.Defaults to False.
